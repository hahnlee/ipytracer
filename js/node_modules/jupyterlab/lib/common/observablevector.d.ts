import { IterableOrArrayLike } from 'phosphor/lib/algorithm/iteration';
import { ISequence } from 'phosphor/lib/algorithm/sequence';
import { Vector } from 'phosphor/lib/collections/vector';
 ...
 */
export interface IObservableVector<T> extends IDisposable, ISequence<T> {
    /**
 ...
 */
export declare class ObservableVector<T> extends Vector<T> implements IObservableVector<T> {
    /**
     * A signal emitted when the vector has changed.
     */
 ...
 */
export declare namespace ObservableVector {
    /**
