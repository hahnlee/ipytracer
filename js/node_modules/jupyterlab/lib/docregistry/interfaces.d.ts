import { Contents, IKernel, Session, Kernel } from 'jupyter-js-services';
 ...
 */
export interface IWidgetFactory<T extends Widget, U extends IDocumentModel> extends IDisposable {
    /**
 ...
 */
export interface IWidgetExtension<T extends Widget, U extends IDocumentModel> {
    /**
 ...
 */
export interface IModelFactory<T extends IDocumentModel> extends IDisposable {
    /**
