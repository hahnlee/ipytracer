import { DOMWidgetModel, DOMWidgetView } from './widget';
/**
 * Represents a group of CSS style attributes
 */
export declare class LayoutModel extends DOMWidgetModel {
    defaults(): any;
}
export declare class LayoutView extends DOMWidgetView {
    /**
     * Public constructor
     */
